...
const AddAdvertisementModal = ({ onClose, onSubmit, positions }) => {
      ...
      <div className="bg-base-100 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-base-content">Add New Advertisement</h2>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium">Advertisement Image *</span>
              </label>
              ...
              <div className="mb-4">
                ...
                <p className="text-xs text-base-content/60 mt-1">
                  Enter image URL or upload an image file below
                </p>
              </div>
