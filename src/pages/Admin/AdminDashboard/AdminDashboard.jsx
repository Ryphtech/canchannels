...
import AdBannerAdmin from '../../../components/Admin/AdBannerAdmin/AdBannerAdmin'
...
const AdminDashboard = () => {
  ...
  return (
    <div data-theme={theme} className="max-w-7xl mx-auto px-4 py-8 bg-base-100 min-h-screen transition-colors duration-300">
      <AdBannerAdmin image = 'https://cdn.shopify.com/s/files/1/0397/9113/2717/files/banner_website.jpg?v=1751957812&width=2048' link="https://example.com"/>
      {/* Theme Toggle Button */}
